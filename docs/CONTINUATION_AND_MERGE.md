...
Модуль [continuation.py](file:///f:/projects/Academic-Pipeline-Engine/academic_pe/core/continuation.py) анализирует входящий контекст и инструкции пользователя, классифицируя задачу в один из трех типов (`EditorialIntent`):
...
Интерфейс операций описан в [merge_operations.py](file:///f:/projects/Academic-Pipeline-Engine/academic_pe/core/merge_operations.py).
...
Модуль [section_patch.py](file:///f:/projects/Academic-Pipeline-Engine/academic_pe/core/section_patch.py) применяет эти инструкции построчно к исходному тексту:
