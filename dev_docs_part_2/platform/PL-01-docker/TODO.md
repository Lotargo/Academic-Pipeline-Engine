...
- `PLAN.md`
- PLAN только контейнеризируемого процесса
...
- [x] `PL-01-T005` Добавить non-root runtime и healthchecks.
- [x] `PL-01-T006` Добавить image build/smoke tests.
- [ ] `PL-01-T007` Создать walkthrough-отчёт.
