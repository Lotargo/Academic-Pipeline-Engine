...
export function AdminDashboard() {
  return <section className="space-y-6"><div><div className="flex items-center gap-2 text-sm text-ape-primary-text"><ShieldCheck className="size-4" />Защищённый раздел</div><h1 className="mt-1 text-3xl font-bold tracking-tight">Администрирование</h1><p className="mt-2 text-muted-foreground">Управляйте пользователями, глобальными ресурсами и состоянием платформы.</p></div><div className="grid gap-4 sm:grid-cols-2 xl:grid-cols-3"><AdminSummary href="/admin/users" icon={UsersRound} title="Пользователи и роли" description="Управление доступом и ролями участников." /><AdminSummary href="/admin/resources" icon={Bot} title="Провайдеры и ресурсы" description="Глобальные credentials, модели и лимиты." /><AdminSummary href="/admin/jobs" icon={ClipboardList} title="Задания и очереди" description="Состояние обработчиков и фоновых заданий." /></div></section>
}
