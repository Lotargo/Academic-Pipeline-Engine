...
export function SessionGate({ children }: { children: React.ReactNode }) {
  const pathname = usePathname(); const router = useRouter(); const isPublic = pathname === "/login" || pathname === "/register"; const [ready, setReady] = useState(isPublic); const [session, setSession] = useState<SessionContext | null>(null)
  useEffect(() => {
